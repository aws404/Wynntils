...
public class ChatConfig extends SettingsClass {
    ...
    @Setting(displayName = "Chat Mention Nicknames", description = "List of additional names that trigger a notification, multiple can be defined by seperating with commas. The player username is all ways included.")
